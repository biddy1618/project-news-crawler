...
#     crawl_and_save_to_file(start_date=start_date, end_date=end_date, file_name=file_name)
# crawl_and_save_to_file(start_date='01.12.2013', end_date='01.01.2014', file_name='./data/1213.json')
...
for month in MONTHS:
    ...
    crawl_and_save_to_file(start_date=start_date, end_date=end_date, file_name=file_name)
crawl_and_save_to_file(start_date='01.12.2014', end_date='01.01.2015', file_name='./data/1214.json')
